...
python pyflickr-upload.py --tag=arijascamera --tag=wave4 "/Volumes/Untitled/Users/Arija/Desktop/camera contents - sort this/" -o uploaded.csv --unattend --threadpool-size=3 $*
