...
python pyflickr-upload.py --tag=arijascamera --tag=wave3 "/Volumes/Untitled/Users/Arija/Desktop/camera contents - sort this/" -o uploaded.v3.csv --unattend --threadpool-size=3 $*
